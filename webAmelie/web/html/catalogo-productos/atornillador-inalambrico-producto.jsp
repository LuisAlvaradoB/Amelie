<%-- 
    Document   : atornilladorInalambrico
    Created on : 13-nov-2018, 14:57:05
    Author     : luis
--%>
...
<head>
    ...
    <title>R3D | Producto-atornillador-inalambrico</title>
</head>
<body>
    ...
    <div class="ed-container main-caract">
        <div class="ed-item l-25" name="">
            <h2>Atornillador inalámbrico 1/4"</h2>
            <img class="img-producto to-center" src="../../img/herramientas/atornillador-electrico.jpeg" alt="pasta-de-soldar"/>
        </div>
        <div class="ed-item l-50">
         ...
         <div class="ed-item l-25">
             <div class="ed-item">
                 ...
                 <p>
                     Atornillador Electrico de uso versátil.
                 </p>
